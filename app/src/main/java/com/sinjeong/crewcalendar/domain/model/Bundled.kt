...
object Bundled {
     ...
     *  · **대체공휴일 7회**(2/9 설 · 5/3 노동절 · 7/19 제헌절 · 8/16 광복절 · 10/4 개천절 ·
     *    10/11 한글날 · 12/27 성탄절)와 연휴 목록(1/1~3 · 2/6~9 · 5/1~3 · 7/17~19 · 8/14~16 ·
     *    9/14~16 · 10/2~4 · 10/9~11 · 12/25~27). https://www.vegannews.co.kr/news/article.html?no=383666
    ...
    val PUBLIC_HOLIDAYS: Map<LocalDate, String> = mapOf(
        ...
        d27(5, 1) to "노동절", d27(5, 3) to "대체휴일",                          // 토 → 월
        d27(5, 5) to "어린이날",                                                // 수
