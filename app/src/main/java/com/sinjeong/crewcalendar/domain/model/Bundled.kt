...
object Bundled {
    ...
    val PUBLIC_HOLIDAYS: Map<LocalDate, String> = mapOf(
        ...
        d(3, 1) to "삼일절", d(3, 2) to "대체공휴일", d(5, 5) to "어린이날",
        d(5, 24) to "부처님오신날", d(5, 25) to "대체공휴일", d(6, 6) to "현충일",
        d(8, 15) to "광복절", d(8, 17) to "대체공휴일",
        d(9, 24) to "추석연휴", d(9, 25) to "추석", d(9, 26) to "추석연휴",
        d(10, 3) to "개천절", d(10, 5) to "대체공휴일", d(10, 9) to "한글날",
        d(12, 25) to "성탄절",
    )
