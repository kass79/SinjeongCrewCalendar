 ...
 * 지선 휴일 1·3·6은 2026-09 개정 안내문 기준(교대 양천구청 12:55→12:41, 14:55→14:41).
...
object RouteTable {
    ...
    val MAIN_NIGHT: Map<Int, Map<NightCombo, TrainAssignment>> = mapOf(
        33 to mapOf(
            // 5925: v1.6.78 정정 — **전·후반 칸이 어긋나 있었다**(주간 17번과 같은 계열의 오류).
            // 번들 행로표 `pp_33` 직접 판독: 전반은 2343(17:21)·2391·2439·5944 ▽20:35에서 끝나고,
            // 후반은 **신정기지 5:52 ○출고 → 5925 → 신도림 5:57 → "39 Dia 2015열차 연결"**,
            // 그 뒤 6:00~6:30이 사업소로 돌아가는 편승 점선이다(열번이 아니라 귀소 시간).
            // 어긋난 채로는 후반 칸에 네 자리 열번이 없어 알람이 통째로 꺼져 있었다.
            // 같은 후반을 그대로 도는 `33 휴평`("2015열차교대·5925")과 값이 일치한다.
            NightCombo.PP to TrainAssignment("2343·2391·2439·5944", "5925·(39Dia 2015열차 연결)", "10:56"),
     ...
     * 지선 주간 휴일·토
     *
     * **2026-09-06 배포 개정 행로표 PDF(`지선행로표 휴일(26.9개정)`)와 지1~지8 전수 대조 완료**(v1.7.8).
     * 열번·계·사업시각 전부 일치했고 **바뀐 칸은 지8의 계 하나뿐**이다(8:09 → **8:10**).
     * PDF 머리글은 `2025.03.04.` 그대로지만 파일명이 `26.9개정`이고 내용이 개정본이다 — **내용이 기준**.
     */
    val BRANCH_DAY_HOLIDAY: Map<Int, TrainAssignment> = mapOf(
        // 1·3·6은 2026-09 회사 개정 안내문으로 갈았다 — 교대 지점이 양천구청 12:55 → **12:41**,
        // 14:55 → **14:41**로 당겨졌다. 열차 한 편씩 앞으로 밀리고 계도 따라 바뀐다.
        // 1번: 5581을 양천구청 12:41에 넘겨받아(신도림 12:46 도착 → 5586 신도림 12:50 발)
        //      마지막 5605를 양천구청 14:41에 넘겨준다. **5610은 이제 3번 몫**이다. 계 7:32 → 7:31.
        1 to TrainAssignment("5527·5532·5533·5538·5539·5544·5545·5550·5551·5556", "5581·5586·5587·5592·5593·5598·5599·5604·5605", "7:31"),
        2 to TrainAssignment("5530·5531·5536·5537·5542·5543·5548·5549·5554", "5601·5606·5607·5612·5613·5618·5619·5624·5625", "8:48"),
        // 3번: 5605를 양천구청 **14:41**에 넘겨받는다(종전 14:55). 후반이 한 편 길어져 계 8:47 → 9:00.
        3 to TrainAssignment("5529·5534·5535·5540·5541·5546·5547·5552·5553", "5605·5610·5611·5616·5617·5622·5623·5628·5629·5634", "9:00"),
        ...
        // 6번: 전반을 5581 양천구청 **12:41** 인계로 마친다(종전 12:55, 5586까지 끌었다).
        //      5586은 이제 1번 몫이다. 후반은 무변경. 계 9:19 → 9:06.
        6 to TrainAssignment("5556·5557·5562·5563·5568·5569·5574·5575·5580·5581", "5634·5635·5640·5641·5646·5647·5652·5653·5658", "9:06"),
        7 to TrainAssignment("5577·5582·5583·5588·5589·5594·5595·5600·5601", "5638·5639·5644·5645·5650·5651·5656·5657·5662", "7:42"),
        // 8번: 개정 PDF 의 계가 **8:10**이다(옛 표 8:09). 열번·사업시각은 한 칸도 안 바뀌었다.
        //      PDF 안에서도 운전 4:14 + 준비 0:30 + 대기 3:05 + 정리 0:20 = 8:09 로 계 칸과 1분 어긋나지만,
        //      앱은 **인쇄된 `계` 칸을 그대로** 싣는다(총근무시간 표시·주52시간 합계 둘 다 이 값).
        8 to TrainAssignment("5584·5585·5590·5591·5596·5597·5602·5603·5608·5609·5614", "5649·5654·5655·5660·5661·5666·5667·5672", "8:10"),
    )
