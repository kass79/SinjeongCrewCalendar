...
object MainLegs {
    val WEEKDAY: Map<Int, List<String>> = mapOf(
        ...
        // 4·7 후반 두 칸은 시각표에서 서로 뒤바뀌어 있었다 (v1.6.31 사용자 확정).
        // 행로표 스캔 `wd_4`: 편승 양천구청 13:46 → 신도림 14:01 발 2261 → 2295 → 2333 → 17:01 → 퇴근 17:16.
        // 사용자 실근무 확인: "4다이아 후반 편승 13:51 → 알람 13:46".
        4 to listOf("7:30", "10:45", "14:01", "17:16"),
        5 to listOf("7:47", "10:55", "15:20", "17:05"),
        6 to listOf("7:52", "11:00", "15:26", "17:26"),
        // 행로표 스캔 `wd_7`: 편승 양천구청 15:21 → 신도림 15:36 발 2297 → 2335 → 17:06 → 퇴근 17:21.
        // 사용자 실근무 확인: "7다이아 후반 편승 15:21 → 알람 15:16".
        7 to listOf("7:41", "9:19", "15:36", "17:21"),
