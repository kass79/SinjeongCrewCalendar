...
object MainLegs {
    val WEEKDAY: Map<Int, List<String>> = mapOf(
        ...
        // ── 4·7 후반은 개정으로 서로 맞바뀌었다 (v1.6.54) ──────────────────────────
        // 근거: 2026-08-23 회사 배포 `4 7개정 행로표` PDF(2쪽 = 4번 교번 18-49, 3쪽 = 7번 교번 24-48)
        //       직접 판독 + 사용자 확정. **개정으로 4·7 후반이 서로 맞바뀌었다.**
        //       v1.6.31이 확정한 옛 값(4 = 14:01/17:16, 7 = 15:36/17:21)은 **개정 전 기준**이었다 —
        //       그때는 그 값이 맞았으므로 되돌리지 말 것.
        // 개정 PDF 4번: 전반 편승 7:15 → 7:30 발 2057·2121·2605·5922 ▽10:45 /
        //              후반 편승 15:21 → 신도림 15:36 발 2297·2335 → 17:06 → 퇴근 17:21. 계 10:56.
        // 개정 PDF 7번: 전반 편승 7:26 → 7:41 발 2060·2114·6928 ▽9:19 /
        //              후반 편승 13:46 → 신도림 14:01 발 2261·2295·2333 → 17:01 → 퇴근 17:16. 계 10:41.
        // 전반 두 칸은 개정 전후가 같아 그대로다. 번들 행로표 이미지 `wd_4`·`wd_7`은 v1.6.57에서
        // 개정 PDF 원본으로 교체돼 이제 이 값과 일치한다(그림 후반 4 = 15:36 · 7 = 14:01).
