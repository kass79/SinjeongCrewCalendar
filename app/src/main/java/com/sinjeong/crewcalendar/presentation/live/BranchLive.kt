...
internal object BranchLive {
    ...
    private val API_KEYS = listOf(
        ...
        // 2026-09-05 사용자 제공 3개 — 7000 → 10000회. 셋 다 실호출로 확인(INFO-200 = 키 인증 통과).
        // 세 번째는 32자(순번이 세 자리 "128")라 다른 키(30자)보다 길다 — 오타가 아니다.
        "4757675a4f6b617338384442657459",
        "754d7962636b617337367369627657",
        "434e4954646b617331323864506d5a71",
    )
